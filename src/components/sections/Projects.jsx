          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition'>
              ...
              <div className='flex justify-between items-center'>
                <a
                  href='https://ramzsanchez.github.io/vue-pomodoro/'
            ...
            '
            >
              <h3 className='text-xl font-bold mb-2'>Tagalog Hate Speech Detection</h3>
              <p className='text-gray-400 mb-4'>
                Undergraduate thesis where an Ensemble Model increased hate speech detection by 10%
              </p>
              <div className='flex flex-wrap gap-2 mb-4'>
                {['Python', 'TensorFlow', 'SciKit Learn', 'RoBERTa', 'XGBoost'].map((tech, key) => (
                  <span
                    key={key}
                    className='
              ...
              <div className='flex justify-between items-center'>
                <a
                  href='https://github.com/ramzsanchez/Tagalog-Hate-Speech-Detection'
                  className='text-blue-400 hover:text-blue-300 transition-colors my-4'
                >
                  View Project →
                </a>
